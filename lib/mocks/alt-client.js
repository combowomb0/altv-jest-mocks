...
class MockEntity extends MockWorldObject {
  ...
  getByScriptID = jest.fn().mockReturnValue(new MockEntity());
}
class MockPlayer extends MockEntity {
  ...
  getByScriptID = jest.fn().mockReturnValue(new MockPlayer());
}
class MockVehicle extends MockEntity {
  ...
  getByScriptID = jest.fn().mockReturnValue(new MockVehicle());
}
