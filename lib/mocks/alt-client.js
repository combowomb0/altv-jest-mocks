...
class MockVehicle extends MockEntity {
  ...
  handling = new MockVehicleHandling();
  speed = 0;
  getByID = jest.fn().mockReturnValue(this);
  getByScriptID = jest.fn().mockReturnValue(this);
}
...
class MockDiscord {
  currentUser = new MockDiscordUser();
}
class MockFile {
...
const mock = {
  ...
  getCursorPos: jest.fn().mockReturnValue(new MockVector2()),
  ...
  VehicleHandling:MockVehicleHandling
};
